  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-gold text-primary-foreground font-semibold shadow-gold hover:shadow-gold-sm hover:-translate-y-0.5 hover:brightness-110",
        gold: "bg-primary text-primary-foreground font-medium hover:bg-primary-glow shadow-gold-sm",
        outlineGold: "border border-primary/40 bg-transparent text-primary hover:bg-primary/10 hover:border-primary",
      },
      size: {
